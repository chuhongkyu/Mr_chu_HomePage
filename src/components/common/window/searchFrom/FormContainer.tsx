...
const FormContainer = () => {
  const isSearchWindowVisible = useSelector(
    (state: RootState) => state.searchWindow.isSearchWindowVisible
  );
    ...
    <AnimatePresence mode="wait" initial={false}>
      {isSearchWindowVisible && (
        ...
        >
          ...
          <div
            className={styles["form-container-dim"]}
            onClick={onHandeleDimClose}
          />
        </motion.section>
      )}
    </AnimatePresence>

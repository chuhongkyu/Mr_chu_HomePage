...
import ContentOne from "@/components/game/ContentOne";
import ContentThree from "@/components/game/ContentThree";
import ContentTwo from "@/components/game/ContentTwo";
...
const UnityContainer = () => {
  ...
  const scrollToSection = (id: string) => {
    const index = gameData.findIndex((el) => el.id === id);
